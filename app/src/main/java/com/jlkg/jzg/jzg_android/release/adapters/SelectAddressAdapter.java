...
public class SelectAddressAdapter extends RecyclerView.Adapter {
    ...
    public SelectAddressAdapter(Context context, List<SuggestionResult.SuggestionInfo> list, OnItemClickListener listener) {
        mContext = context;
        mList = list;
        mListener = listener;
    }
    ...
    public void onBindViewHolder(RecyclerView.ViewHolder holder, final int position) {
        ...
        viewHolder.mTvCompanyName.setText(mList.get(position).key);
