...
public class TeamPersonListAdapter extends RecyclerView.Adapter {

    private Context mContext;
    private List<TeamPersonBean> mList;
    private OnItemClickListener mListener;

    public TeamPersonListAdapter(Context context, List<TeamPersonBean> list, OnItemClickListener listener) {
        mContext = context;
        mList = list;
        mListener = listener;
    }
