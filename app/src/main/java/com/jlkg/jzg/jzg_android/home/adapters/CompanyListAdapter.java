...
public class CompanyListAdapter extends RecyclerView.Adapter {
    ...
    public CompanyListAdapter(Context context, List<SelectTypeBean.SelectTypeChildBean> list, OnItemClickListener listener) {
        mContext = context;
        mList = list;
        mListener = listener;
    }
    ...
    public void onBindViewHolder(RecyclerView.ViewHolder holder, final int position) {
        ...
        if (mList != null) {
            TextUtils.setText(viewHolder.mTvCompanyName, mList.get(position).type);
        }
