...
public class ChangeRoleActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        System.out.println("============MyApplication="+MyApplication.isCompany);
...
//                    PrefUtils.setBoolean(this, AppConstants.ISLOGIN,false);
                    ...
                    PrefUtils.getBoolean(this, PreFiled.ISCOMPANY, true);
...
//                    PrefUtils.setBoolean(this, AppConstants.ISLOGIN,false);
                    ...
                    ChangeRoleEvent changeRoleEvent=new ChangeRoleEvent();
                    EventBus.getDefault().post(changeRoleEvent);
                    PrefUtils.setBoolean(this, PreFiled.ISCOMPANY, false);
                    setResult(Activity.RESULT_OK);
                }
                finish();
                break;
