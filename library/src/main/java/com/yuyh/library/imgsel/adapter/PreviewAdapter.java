    ...
    public View instantiateItem(ViewGroup container, final int position) {
        ...
        if (config.multiSelect) {
            ...
            if (Constant.imageList.contains(image.path)) {
                ivChecked.setImageResource(R.drawable.check_pic);
            } else {
                ivChecked.setImageResource(R.drawable.un_check_pic);
            }
        ...
        container.addView(root, ViewGroup.LayoutParams.WRAP_CONTENT,
